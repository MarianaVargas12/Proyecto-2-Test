...
bool Poblacion::creacion(int cantidad){
    seleccion();
    int transfromar;
...
bool Poblacion::poblacionInicial(int cantidad){
    for (int i=0;i<cantidad;i++) {
        int vida=2;
        int id=rand()%3000;;
        int edad=(rand()%20 +1);
